...
pub fn build_router(cfg: Config) -> Router {
    ...
    let api = Router::new()
        ...
        .route("/orbnet/disable",         post(crate::orbnet::disable))
        .route("/orbnet/moderation",      post(crate::orbnet::set_moderation))
        .route("/orbnet/rooms",           get(crate::orbnet::rooms))
        .route("/orbnet/rooms/:id/send",  post(crate::orbnet::send))
        ...
        .route("/orbnet/persona",         post(crate::orbnet::place_persona))
        ...
        .route("/orbnet/rooms/:id/leave", post(crate::orbnet::leave_room))
        .route("/orbnet/rooms/:id/kick",  post(crate::orbnet::kick_member))
        .route("/orbnet/peers",           get(crate::orbnet::peers))
        .route("/orbnet/peer/remove",     post(crate::orbnet::unpeer))
        .route("/orbnet/persona/remove",  post(crate::orbnet::remove_persona))
        .route("/orbnet/persona/update",  post(crate::orbnet::update_persona))
        .route("/orbnet/llm-sources",     get(crate::agent_connect::llm_sources))
        // Hidden Services — host Tor v3 onions (admin-only over REST; agent-capable via MCP)
        .route("/onions/status",  get(crate::onions::status))
        .route("/onions/enable",  post(crate::onions::enable))
        ...
        // Aeon Bench — deploy pod + verified-path remote endpoint benches
        ...
        .route("/bench/ssh_key", get(crate::bench::ssh_key))
        .route("/bench/authorize", post(crate::bench::authorize))
        .route("/bench/scan_endpoints", get(crate::bench::scan_endpoints))
        .route("/bench/run_verified", post(crate::bench::run_verified))
        .route("/bench/jobs", get(crate::bench::jobs))
        ...
        .route("/ipfs/disable", post(crate::ipfs::disable))
        .route("/ipfs/storage", post(crate::ipfs::set_storage))
        .route("/ipfs/pin",     post(crate::ipfs::pin))
        ...
        .route("/ipfs/models/import-civitai", post(crate::ipfs::import_civitai))
        .route("/ipfs/models/tokens", get(crate::ipfs::get_source_tokens).post(crate::ipfs::set_source_token))
        .route("/ipfs/models/view", get(crate::ipfs::get_view_settings).post(crate::ipfs::set_view_settings))
        .route("/ipfs/models/seed", get(crate::ipfs::get_seed).post(crate::ipfs::set_seed))
        ...
        .route("/mysterium/register", post(crate::mysterium::register))
        .route("/mysterium/beneficiary", post(crate::mysterium::beneficiary))
