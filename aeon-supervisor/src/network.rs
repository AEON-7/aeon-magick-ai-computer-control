...
pub async fn get_vpn(State(_state): State<AppState>) -> Json<Value> {
    ...
    Json(json!({
        ...
        "providers": [
            ...
            {"id": "mullvad", "label": "Mullvad VPN", "blurb": "Swedish HQ, multiple 3rd-party audits, anonymous account (16-digit number, no email). The most-trusted of the three. Setup wizard at /network/vpn/providers/mullvad."},
            {"id": "ivpn", "label": "IVPN", "blurb": "Gibraltar HQ (outside 14-Eyes), audited by Cure53. Smaller server fleet than Mullvad. Setup wizard at /network/vpn/providers/ivpn."},
            {"id": "azirevpn", "label": "AzireVPN", "blurb": "Swedish boutique provider. Long-running no-log claim but no formal 3rd-party audit. Setup wizard at /network/vpn/providers/azirevpn."},
